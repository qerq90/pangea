...
/** Божественное оружие в доп. слоте: удар по всему полю боя, раз в раунд, с гранью своего
  * вида; заряды скрыты от игрока, последний удар рассыпает божественное оружие. */
object DivineBattleSpec extends ZIOSpecDefault {
  ...
  override def spec = suite("Божественное оружие доп. слота")(
